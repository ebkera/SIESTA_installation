# Link to original file : https://raw.githubusercontent.com/bgeneto/siesta-gcc-mpi/master/gcc-openmp-arch.make
...
SIESTA_ARCH = x86_64_OMP_Eranjan_v0 Compiled On: ERA_PC ERA_CARBON ERA_FFL0 ERA_FFL1 ERA_FFL2 UIC_Z800
...
# netcdf
INCFLAGS += -I$(INSDIR)/siesta/siesta-master/Docs/build/netcdf/4.6.1/include
LDFLAGS += -L$(INSDIR)/siesta/siesta-master/Docs/build/zlib/1.2.11/lib -Wl,-rpath=$(INSDIR)/siesta/siesta-master/Docs/build/zlib/1.2.11/lib
LDFLAGS += -L$(INSDIR)/siesta/siesta-master/Docs/build/hdf5/1.8.21/lib -Wl,-rpath=$(INSDIR)/siesta/siesta-master/Docs/build/hdf5/1.8.21/lib
LDFLAGS += -L$(INSDIR)/siesta/siesta-master/Docs/build/netcdf/4.6.1/lib -Wl,-rpath=$(INSDIR)/siesta/siesta-master/Docs/build/netcdf/4.6.1/lib
